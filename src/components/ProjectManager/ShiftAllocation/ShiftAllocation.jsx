...
const ShiftAllocation  =() => {
  ...
  const employees = [
    { id: 1, name: 'John Smith', department: 'Customer Service', shifts: [{day: 0, start: '9:00', end: '17:00', type: 'morning'}, {day: 2, start: '12:00', end: '20:00', type: 'evening'}] },
    { id: 2, name: 'Emma Johnson', department: 'Sales', shifts: [{day: 1, start: '8:00', end: '16:00', type: 'morning'}, {day: 3, start: '8:00', end: '16:00', type: 'morning'}, {day: 5, start: '10:00', end: '18:00', type: 'morning'}] },
    { id: 3, name: 'Michael Brown', department: 'IT Support', shifts: [{day: 0, start: '14:00', end: '22:00', type: 'evening'}, {day: 2, start: '14:00', end: '22:00', type: 'evening'}, {day: 4, start: '14:00', end: '22:00', type: 'evening'}] },
    { id: 4, name: 'Sarah Davis', department: 'HR', shifts: [{day: 1, start: '9:00', end: '17:00', type: 'morning'}, {day: 3, start: '9:00', end: '17:00', type: 'morning'}] },
    { id: 5, name: 'Robert Wilson', department: 'Customer Service', shifts: [{day: 0, start: '22:00', end: '6:00', type: 'night'}, {day: 2, start: '22:00', end: '6:00', type: 'night'}, {day: 4, start: '22:00', end: '6:00', type: 'night'}] },
    { id: 6, name: 'Jennifer Lee', department: 'Sales', shifts: [{day: 1, start: '12:00', end: '20:00', type: 'evening'}, {day: 3, start: '12:00', end: '20:00', type: 'evening'}, {day: 5, start: '12:00', end: '20:00', type: 'evening'}] },
    { id: 7, name: 'David Miller', department: 'IT Support', shifts: [{day: 0, start: '9:00', end: '17:00', type: 'morning'}, {day: 4, start: '9:00', end: '17:00', type: 'morning'}] },
  ];
  
  // Department options
  const departments = ['All Departments', 'Customer Service', 'Sales', 'IT Support', 'HR'];
  ...
  const getShiftTypeColor = (type) => {
    switch(type) {
      case 'morning': return 'bg-primary bg-opacity-10 border-primary';
      case 'evening': return 'bg-purple bg-opacity-10 border-purple';
      case 'night': return 'bg-dark bg-opacity-10 border-dark';
                ...
                <thead className="table-light">
                  <tr>
                    ...
                    {weekDates.map((date, index) => (
                      <th key={index} scope="col" className="text-center min-w-150">
                  ...
                  {filteredEmployees.map((employee) => (
                    <tr key={employee.id}>
                      ...
                      {weekDates.map((_, dayIndex) => (
                        <td key={dayIndex} className="position-relative" style={{minHeight: '80px'}}>
                          {employee.shifts.filter(shift => shift.day === dayIndex).map((shift, idx) => (
                            <div 
                              key={idx}
                              className={`border-start border-3 px-2 py-1 mb-1 rounded ${getShiftTypeColor(shift.type)}`}
                            >
                              <div className="fw-medium">{shift.start} - {shift.end}</div>
            ...
            <div className="card" style={{width: '24rem'}}>
              ...
              <div className="card-body">
                <div className="d-flex align-items-center mb-4">
                  <div className="rounded-circle bg-secondary text-white d-flex align-items-center justify-content-center me-3" style={{width: '64px', height: '64px', fontSize: '1.25rem'}}>
                ...
                <div className="mb-4">
                  ...
                  <div className="d-flex flex-column gap-2">
                    {employees
                      .find(e => e.name === selectedEmployee)?.shifts
                      .map((shift, idx) => {
                        const date = new Date(weekDates[shift.day]);
                        return (
                          <div key={idx} className={`border-start border-3 px-3 py-2 rounded ${getShiftTypeColor(shift.type)}`}>
                            <div className="fw-medium">{formatDay(date)}, {formatDate(date)}</div>
