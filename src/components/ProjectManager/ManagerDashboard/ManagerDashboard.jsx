...
function ManagerDashboard() {
    ...
    return (
        <div className="container-fluid bg-main py-3" style={{ minHeight: '100vh' }}>
            {/* Header Section */}
            ...
            <h1 className='gradient-heading ms-3'>Manager Dashboard</h1>
                    ...
                    <div className="col-md-6 col-lg-3 mb-4">
                        <div className="card  bg-card  h-100 shadow-sm">
                            <div className="card-body">
                                ...
                                <div className="progress mt-2" style={{ height: '6px' }}>
                                    <div className="progress-bar bg-success" style={{ width: '24.8%' }}></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-8 mb-4">
                        <div className="card shadow-sm">
                            <div className="card-header table-gradient-bg border-bottom d-flex justify-content-between align-items-center py-3">
                                <h5 className="mb-0">Project Status</h5>
                                <div className="d-flex align-items-center">
                                    <button className="btn btn-link text-primary me-3 small">View All</button>
                                    <div className="dropdown">
                                        <button className="btn btn-sm btn-outline-secondary dropdown-toggle" type="button" id="filterDropdown" data-bs-toggle="dropdown">
                                            Filter
                                        </button>
                            ...
                            <div className="table-responsive">
                                <table className="table table-hover table-gradient-bg mb-0">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div className="fw-bold">Enterprise CRM Implementation</div>
                                            ...
                                            <td>Jul 15, 2025</td>
                                            <td>
                                                <span className="badge bg-success bg-opacity-10 text-success">In Progress</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div className="fw-bold">Market Analysis Report</div>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div className="fw-bold">Mobile App Development</div>
                                            ...
                                            <td>
                                                <div className="d-flex">
                                                    ...
                                                    <img 
                                                        ...
                                                        alt="" 
                                                    />
                                                    <div className="rounded-circle border border-white ms-n2 bg-light d-flex align-items-center justify-content-center" style={{ width: '32px', height: '32px' }}>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div className="fw-bold">Digital Marketing Campaign</div>
                                            ...
                                            <td>Jun 10, 2025</td>
                                            <td>
                                                <span className="badge bg-secondary bg-opacity-10 text-secondary">Completed</span>
                                            </td>
                                            <td>
                                                <div className="d-flex">
                                                    <img 
                    ...
                    <div className="col-lg-4 mb-4">
                        <div className="card shadow-sm h-100">
                            <div className="card-header bg-card border-bottom d-flex justify-content-between align-items-center py-3">
                                <h5 className="mb-0">Recent Activities</h5>
                                <button className="btn btn-link text-primary small">View All</button>
                            </div>
                            <div className="card-body bg-card">
                                <div className="activity-feed">
                                    <div className="d-flex  position-relative mb-4">
                                        <div className="flex-shrink-0">
                                            <span className="bg-primary rounded-circle d-flex align-items-center justify-content-center" style={{ width: '32px', height: '32px' }}>
                                                <i className="fas fa-user-plus text-white small"></i>
                                            </span>
                                        </div>
                                        <div className="flex-grow-1 ms-3">
                                            <p className="small mb-0">New lead <span className="fw-bold">Acme Corp</span> added to pipeline</p>
                                            <p className=" small">2h ago</p>
                                        </div>
                                    </div>
                                    <div className="d-flex position-relative mb-4">
                                        <div className="flex-shrink-0">
                                            <span className="bg-success rounded-circle d-flex align-items-center justify-content-center" style={{ width: '32px', height: '32px' }}>
                                                <i className="fas fa-tasks text-white small"></i>
                                            </span>
                                        </div>
                                        <div className="flex-grow-1 ms-3">
                                            <p className="small mb-0">Project <span className="fw-bold">Mobile App Development</span> reached 90% completion</p>
                                            <p className=" small">4h ago</p>
                                        </div>
                                    </div>
                                    <div className="d-flex position-relative mb-4">
                                        <div className="flex-shrink-0">
                                            <span className="bg-indigo rounded-circle d-flex align-items-center justify-content-center" style={{ width: '32px', height: '32px' }}>
                                                <i className="fas fa-comment-alt text-white small"></i>
                                            </span>
                                        </div>
                                        <div className="flex-grow-1 ms-3">
                                            <p className="small mb-0"><span className="fw-bold">Sarah Johnson</span> commented on proposal for <span className="fw-bold">TechStart Inc</span></p>
                                            <p className=" small">Yesterday</p>
                                        </div>
                                    </div>
                                    <div className="d-flex position-relative mb-4">
                                        <div className="flex-shrink-0">
                                            <span className="bg-warning rounded-circle d-flex align-items-center justify-content-center" style={{ width: '32px', height: '32px' }}>
                                                <i className="fas fa-calendar-alt text-white small"></i>
                                            </span>
                                        </div>
                                        <div className="flex-grow-1 ms-3">
                                            <p className="small mb-0">Meeting scheduled with <span className="fw-bold">Global Solutions Ltd</span></p>
                                            <p className=" small">2 days ago</p>
                                        </div>
                                    </div>
                                    <div className="d-flex position-relative">
                                        <div className="flex-shrink-0">
                                            <span className="bg-danger rounded-circle d-flex align-items-center justify-content-center" style={{ width: '32px', height: '32px' }}>
                                                <i className="fas fa-dollar-sign text-white small"></i>
                                            </span>
                                        </div>
                                        <div className="flex-grow-1 ms-3">
                                            <p className="small mb-0">Deal closed with <span className="fw-bold">Nexus Technologies</span> - <span className="fw-bold text-success">$125,000</span></p>
                    ...
                    <div className="card-header bg-card border-bottom d-flex justify-content-between align-items-center py-3">
                        ...
                        <div className="d-flex align-items-center">
                            <div className="dropdown me-3">
                                <button className="btn btn-outline-secondary dropdown-toggle" type="button" id="timeFilterDropdown" data-bs-toggle="dropdown">
                                    {timeFilter}
                                </button>
                                <ul className="dropdown-menu" aria-labelledby="timeFilterDropdown">
                                    <li><button className="dropdown-item" onClick={() => setTimeFilter('This Week')}>This Week</button></li>
                                    <li><button className="dropdown-item" onClick={() => setTimeFilter('This Month')}>This Month</button></li>
                                    <li><button className="dropdown-item" onClick={() => setTimeFilter('This Quarter')}>This Quarter</button></li>
                                </ul>
                            </div>
