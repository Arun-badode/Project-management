...
const ResourceManagement = () => {
          ...
          <div className="card-body bg-card">
            <BarChart
              ...
              data={projects.map(project => ({
                ...
                duration: moment(project.endDate).diff(moment(project.startDate), 'weeks')
              }))}
  ...
  return (
    <div className="p-4 py-4">
      ...
      {/* Add Resource Modal */}
      <Modal show={showResourceForm} onHide={() => setShowResourceForm(false)} size="lg" className='custom-modal-dark'>
            ...
            <div className="mb-3">
              ...
              <div className="d-flex flex-wrap gap-2">
                {allSkills.map(skill => (
                  <Button
                    key={skill}
                    variant={newResource.skills.includes(skill) ? 'primary' : 'outline-primary'}
                    size="sm"
                    className='bg-card'
        ...
        <Modal.Footer>
          <Button variant="danger" onClick={() => setShowResourceForm(false)} className='rounded-pill'>
            Cancel
          </Button>
          <Button variant="primary" onClick={addResource} className='gradient-button'>
            Add Resource
          </Button>
        </Modal.Footer>
      </Modal>
      ...
      <Modal show={showResourceDetails} onHide={() => setShowResourceDetails(false)} size="lg" className='custom-modal-dark'>
        {selectedResource && (
          <>
            <Modal.Header closeButton>
              ...
              <div className="row">
                ...
                <div className="col-md-8">
                  ...
                  <div className="row">
                    <div className="col-md-6 mb-3">
                      <h6>Availability</h6>
                      <ProgressBar now={selectedResource.availability} label={`${selectedResource.availability}%`} />
                    </div>
                    <div className="col-md-6 mb-3">
                      <h6>Current Allocation</h6>
                      <ProgressBar 
                        variant={getAllocationClass(selectedResource.allocation)}
            ...
            <Modal.Footer>
              <Button variant="danger" onClick={() => setShowResourceDetails(false)} className='rounded-pill'>
                Close
              </Button>
