...
const AuditLog = () => {
    ...
    const filterData = (data, type) => {
        return data.filter(item => {
            ...
            if (type === 'login') {
                typeSpecificMatch = (selectedAction === '' || item.action === selectedAction) &&
                                                ...
                                                <tr key={item.id}>
                                                    {activeTab === 'all-activities' && (
                                                        <>
                                                            ...
                                                            <td><span className="badge bg-secondary">{item.role}</span></td>
                                                            <td>{item.activity}</td>
                                                            <td>{item.module}</td>
                                                    ...
                                                    {activeTab === 'login-logout' && (
                                                        <>
                                                            ...
                                                            <td><strong>{item.user}</strong></td>
                                                            <td><span className="badge bg-secondary">{item.role}</span></td>
                                                            <td><span className={`badge ${item.action === 'Login' ? 'bg-info' : 'bg-warning'}`}>{item.action}</span></td>
                                                    ...
                                                    {activeTab === 'changes-history' && (
                                                        <>
                                                            <td className="text-muted small">{item.timestamp}</td>
                                                            <td><strong>{item.user}</strong></td>
                                                            <td><span className="badge bg-info">{item.entityType}</span></td>
                                                            <td><span className={getActionBadge(item.action)}>{item.action}</span></td>
                                                            <td><strong>{item.entityName}</strong></td>
                                            ...
                                            <div className="col-md-6">
                                                ...
                                                <div className="bg-light p-3 rounded">
                                                    {modalData.beforeAfter.before ? (
                                                        <pre className="mb-0">{JSON.stringify(modalData.beforeAfter.before, null, 2)}</pre>
                                                    ) : (
                                            ...
                                            <div className="col-md-6">
                                                ...
                                                <div className="bg-light p-3 rounded">
                                                    {modalData.beforeAfter.after ? (
                                                        <pre className="mb-0">{JSON.stringify(modalData.beforeAfter.after, null, 2)}</pre>
                                                    ) : (
